...
| `AUTH_URL`                              | URL for the authentication service (deprecated; prefer built-in platform auth) | No       | None                                  | `auth_service_url`                            |
...
| `EXTERNAL_GENAI_URL_DEV`                | Optional dev upstream URL for env-specific GenAI routes                        | No       | None                                  | `http://genai-dev:8080`                       |
| `EXTERNAL_GENAI_URL_PROD`               | Optional prod upstream URL                                                     | No       | None                                  | `http://genai-prod:8080`                      |
| `EXTERNAL_GENAI_URL_STAGING`            | Optional staging upstream URL                                                  | No       | None                                  | `http://genai-staging:8080`                   |
