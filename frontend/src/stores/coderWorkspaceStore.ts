...
import type { WorkspaceAgentLog, WorkspaceInfo, WorkspaceStatus } from '@/services/coder.service'
...
const useCoderWorkspaceStore = createWithEqualityFn<State & Actions>()((set, get) => ({
  byPrototypeId: {},
