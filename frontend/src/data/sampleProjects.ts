...
export const SAMPLE_PROJECTS: SampleProject[] = [
  {
    ...
    language: 'github',
    description: 'Import a project directly from a GitHub repository URL',
    data: [
      {
        type: 'folder',
        name: 'github-project',
        items: [
          {
            ...
            content:
              '# Import from GitHub\n\nTo clone a GitHub repository:\n\n1. Enter a valid GitHub repository URL in the format:\n   - `https://github.com/owner/repository`\n   - `github.com/owner/repository`\n   - `owner/repository`\n\n2. Click the "Import from GitHub" button\n\n3. The system will:\n   - Fetch the repository contents\n   - Auto-detect the programming language\n   - Extract the main source file(s)\n   - Create a prototype with the repository code\n\n## Supported Languages\n- Python (.py)\n- Rust (.rs)\n- C/C++ (.c, .cpp, .cc)\n- JavaScript/TypeScript\n- Others\n\n## Notes\n- Requires a valid public GitHub repository\n- Large repositories may take longer to process\n- File size limits may apply',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    language: 'python',
    description:
      'A simple Python project with multiple files demonstrating basic structure',
    data: [
      {
        type: 'folder',
        name: 'python-project',
  ...
  },
  {
    ...
    language: 'rust',
    description:
      'A Rust project with multiple modules and proper Cargo structure',
    data: [
      {
        type: 'folder',
        name: 'rust-project',
