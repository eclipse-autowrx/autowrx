    ...
    >
      ...
      <div className="mt-6">
        ...
        {showSuggestions && filteredSuggestions.length > 0 && (
          <div className="absolute z-50 mt-1 w-[calc(100%-2rem)] max-h-[18vh] overflow-y-auto rounded-md border border-gray-200 bg-background p-1 shadow-lg">
      ...
      <div className="ml-auto mt-auto flex space-x-2">
        ...
        >
          {loading && <Spinner className="mr-1" size={16} />}
          Create
        </Button>
      </div>
    </form>
